...
/* harmony import */ var utilities_show_passwords_match_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! utilities/show_passwords_match.js */ "./app/javascript/utilities/show_passwords_match.js");
/* harmony import */ var utilities_show_passwords_match_js__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(utilities_show_passwords_match_js__WEBPACK_IMPORTED_MODULE_5__);
...
/***/ "./app/javascript/utilities/show_passwords_match.js":
/*!**********************************************************!*\
  !*** ./app/javascript/utilities/show_passwords_match.js ***!
  \**********************************************************/
/*! no static exports found */
...
var PasswordConfirmation = /*#__PURE__*/function () {
  ...
  _createClass(PasswordConfirmation, [{
    ...
    key: "resetStyleForInputs",
    value: function resetStyleForInputs() {
      this.password_confirm.classList.remove('input-green');
      this.password_confirm.classList.remove('input-red'); // this.password_confirm.parentElement.classList.remove('success')
    ...
    value: function checkPasswords() {
      ...
      if (this.password_confirm.value === this.password.value) {
        ...
        this.password_confirm.classList.add('input-green'); // this.password_confirm.parentElement.classList.add('success')
      } else {
        console.log('Passwords are NOT the same');
        this.password_confirm.classList.add('input-red'); // this.password_confirm.parentElement.classList.add('error')
      }
    }
  }]);
...
/******/ });
//# sourceMappingURL=application-6ab535b7c8109e868397.js.map